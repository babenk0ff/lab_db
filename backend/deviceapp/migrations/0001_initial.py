# Generated by Django 4.1.7 on 2023-04-26 11:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.CharField(help_text='Формат: 123456.789 или 123456.789-01', max_length=13, unique=True, validators=[django.core.validators.RegexValidator(message='Неверный формат номера', regex='^[0-9]{6}.[0-9]{3}(-[0-9]{2})?$')], verbose_name='Цифровая часть децимального номера')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Аппарат, Блок, Комплекс, Ячейка и т.п.', max_length=64, null=True, unique=True, verbose_name='Наименование типа изделия')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('index', models.CharField(blank=True, max_length=64, null=True, verbose_name='Индекс изделия')),
                ('decimal_num', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='deviceapp.decimalnumber', verbose_name='Децимальный номер')),
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='deviceapp.devicetype', verbose_name='Тип изделия')),
            ],
            options={
